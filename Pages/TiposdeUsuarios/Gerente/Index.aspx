<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Pages_TiposdeUsuarios_Gerente_Index" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Pagina Inicial do Gerente</title>
            ...
            <div class="jumbotron" style="background-color: chocolate; padding: 15px; margin-top: 14px; text-align: left;">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <div class="form-group">
                        ...
                        <li class="TopoMenu">
                            <h2>
                                <asp:Label ID="lblTitulo" runat="server" Text="Tela Principal do Gerente"></asp:Label>
                            </h2>
                        </li>
                    </div>
